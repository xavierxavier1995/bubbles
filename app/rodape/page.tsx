...
export default function FooterPreview() {
  return (
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col justify-between font-sans selection:bg-[#F4CDD4] selection:text-[#0D0C0D]">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-4">
        ...
        <p className="text-gray-500 max-w-md">Role para baixo para visualizar o novo rodapé projetado com foco em conversão, autoridade e usabilidade mobile.</p>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="border-t border-gray-200 pt-4 mt-8">
            ...
            <div className="flex flex-wrap justify-center gap-x-2 gap-y-2 text-sm font-medium items-center pb-4 border-b border-gray-100">
              ...
              <a href="#" className="hover:text-[#0D0C0D] transition-colors whitespace-nowrap">Frete</a>
              <span className="text-gray-300">|</span>
              <a href="#" className="hover:text-[#0D0C0D] transition-colors whitespace-nowrap">Garantia</a>
              <span className="text-gray-300">|</span>
              <a href="#" className="hover:text-[#0D0C0D] transition-colors whitespace-nowrap">Privacidade</a>
              <span className="text-gray-300">|</span>
              <a href="#" className="hover:text-[#0D0C0D] transition-colors whitespace-nowrap">Reembolso</a>
              <span className="text-gray-300">|</span>
              <a href="#" className="hover:text-[#0D0C0D] transition-colors whitespace-nowrap">Segurança</a>
              <span className="text-gray-300">|</span>
              <a href="#" className="hover:text-[#0D0C0D] transition-colors whitespace-nowrap">Termos de Serviço</a>
              <span className="text-gray-300">|</span>
              <a href="#" className="hover:text-[#0D0C0D] transition-colors whitespace-nowrap">Troca e Devoluções</a>
            </div>
